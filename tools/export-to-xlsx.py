...
COLUMNS = [
    ("شناسه محصول", 24, "کلید یکتا. تغییرش ندهید — محصول با همین کد پیدا می‌شود."),
...
LOCKED = {"شناسه محصول", "نوع", "مادر", "نام 1 صفت", "مقدار(های) 1 صفت"}
...
def main(src, dest):
    ...
    numeric = {"قیمت عادی", "قیمت فروش ویژه", "انبار", "موقعیت"}
    ...
    for note in [
        ...
        "ستون‌های خاکستری (کد، نوع، مادر، صفت) را تغییر ندهید.",
