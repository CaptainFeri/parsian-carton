...
همچنین ابزار **تبدیل صفت محلی به سراسری** (محصولات ← تبدیل صفت به سراسری) که
صفت‌های محلی را — به‌همراه واریاسیون‌هایشان — به تاکسونومی `pa_*` تبدیل می‌کند تا
در پنل فیلتر قابل استفاده شوند.

📄 [راهنمای کامل](docs/همگام-سازی-با-اکسل.md) — شامل **روش پیشنهادی با گوگل‌شیت**
📊 [کاتالوگ واقعی سایت](docs/محصولات-سایت.xlsx) — ۲۱۵ محصول، آمادهٔ ویرایش
📋 [قالب خالی](docs/قالب-محصولات.xlsx) — برای شروع از صفر
